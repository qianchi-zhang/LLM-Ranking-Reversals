...
* `data/` - Will contain sampled evaluation subsets (MMLU, ARC-Challenge, HellaSwag).
* `src/` - Source code for prompt generation, API orchestration, and evaluation scoring.
* `notebooks/` - Jupyter notebooks for Bootstrap resampling and statistical analysis.
* `docs/` - Project planning and final report documents.
